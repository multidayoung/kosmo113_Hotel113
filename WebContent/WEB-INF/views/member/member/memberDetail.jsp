...
<article class="container">
 ...
 <div class="form-group">
   ...
   <button class="btn btn-primary" type="button"
    onclick="location='${pageContext.request.contextPath}/member/member/memberUpForm?mnum=${vo.mnum}'">수정</button>
   <button class="btn btn-danger" type="button"
    onclick="location='${pageContext.request.contextPath}/member/member/memberDelete?num=${vo.mnum}'">삭제</button>
     </div>
</article>