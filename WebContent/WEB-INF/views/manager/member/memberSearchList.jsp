               ...
               <td colspan="5">
                  <ol class="paging">
                     <c:choose>
                        ...
                        <c:otherwise>
                           <li><a
                              href="memberSearch?cPage=${startPage - 1 }">이전으로</a></li>
                        </c:otherwise>
                     </c:choose>
                     ...
                     <c:forEach varStatus="i" begin="${startPage }" end="${endPage }"
                        ...
                        <c:choose>
                           ...
                           <c:otherwise>
                              <li><a href="memberSearch?cPage=${i.index }&searchName=${searchName}&searchType=${searchType}">${i.index }</a></li>
                           </c:otherwise>
                        </c:choose>
                     </c:forEach>
                      <c:choose>
                        ...
                        <c:otherwise>
                           <li class="page-item"><a class="page-link" href="memberSearch?cPage=${endPage + 1}">
                           다음으로</a></li>
                        </c:otherwise>      
                     </c:choose>
                  </ol>              
